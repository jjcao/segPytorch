...
Created on Sat Sep  2 21:31:55 2017
...
from models.utils import residualBlock, residualBottleneck
from models.utils import conv2DBatchNormRelu, deconv2DBatchNormRelu, conv2DBatchNorm
from models.utils import linknetUp
...
#    def init_resnet18_params(self, resnet18, copy_fc8=True):